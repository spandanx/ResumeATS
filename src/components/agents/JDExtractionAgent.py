...
from schemas.JobDescriptionSchema import JobDescription
from prompts.system_prompts import job_description_system_prompt
from prompts.user_prompts import job_description_user_prompt
