...
class MysqlDB:
    ...
    #         self.reestablish_connection()
    #         print("MySQL Connection is not active")
    #     sql_insert_query = "INSERT INTO stockdoc_user (username, hashed_password, stock_username, disabled) VALUES (%s, %s, %s, %s)"
    #     self.cur.execute(sql_insert_query, (user.username, user.hashed_password, user.stock_username, user.disabled))
    #     self.cnx.commit()
